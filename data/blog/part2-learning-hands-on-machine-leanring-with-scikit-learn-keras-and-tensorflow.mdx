...
For any machine learning project, there is generally a [checklist](https://github.com/ageron/handson-ml/blob/master/ml-project-checklist.md) that is to be followed Aurélien Geron the author of Hands-on Machine Learning with Scikit-Learn, Keras and Tensorflow has made a really good one.
...
**<Latex>$x^i$</Latex>** is a vector of all feature values of the i-th instance in the data

**<Latex>$y^i$</Latex>** is its label
